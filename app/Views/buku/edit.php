...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3" style="text-align: center; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Form Ubah Data Buku</h2>
            <form action="/buku/update/<?= $buku['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control 
                        <?= ($validation->hasError('penulis')) ? 'is-invalid' : ''; ?>" id="penulis" name="penulis" value="<?= (old('penulis')) ?
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control 
                        <?= ($validation->hasError('ringkasan')) ? 'is-invalid' : ''; ?>" id="ringkasan" name="ringkasan" value="<?= (old('ringkasan')) ?
                                                                                                                                        old('ringkasan') : $buku['ringkasan']  ?>">
                        <div class="invalid-feedback">
                            <?= $validation->getError('ringkasan'); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control
                        <?= ($validation->hasError('penerbit')) ? 'is-invalid' : ''; ?>" id="penerbit" name="penerbit" value="<?= (old('penerbit')) ?
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?= ($validation->hasError('tahun')) ? 'is-invalid' : ''; ?>" id="tahun" name="tahun" value="<?= (old('tahun')) ?
                                                                                                                            old('tahun') : $buku['tahun']  ?>">
                        <div class="invalid-feedback">
